...
begin
	...
	adder : for i in 0 to N-1 generate
		...
		output <= '1' when (adjusted_value(I) xor inputb(I)) xor internal_carry(I) else '0';
		internal_carry(I+1) <= '1' when (adjusted_value(I) xor inputb(I)) or (internal_carry(I) and (adjusted_value(I) xor inputb(I))) else '0';
	end generate;
